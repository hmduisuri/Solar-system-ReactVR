...
import {asset, Text, View, VrButton, Model, StyleSheet, Sound} from 'react-vr';
// import classes from "./DescriptionBox.css"
   ...
   return (
     <View style={{
		...
		<VrButton onClick={() => this.changePlanet(1)}
         onClickSound={{ wav: asset('testing.wav') }} loop={true}
        >
